               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a data-scroll href="{{ url('admin')}}">Secretaria </a></li>
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="footer-info padding">
                     <h3>CONTACT US</h3>
                     <p><i class="fa fa-map-marker" aria-hidden="true"></i> Algeria_Tlemcen</p>
                     <p><i class="fa fa-paper-plane" aria-hidden="true"></i> AllaliYasmine@gmail.com</p>
