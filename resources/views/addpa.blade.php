    ...
    <ul class="form-section page-section">
        ...
        <div style="display:table;width:100%">
          <div class="form-header-group hasImage header-large" data-imagealign="Right">
            ...
            <div class="header-logo">
              <img src="./New Patient Enrollment Form_files/dr.5f327cf9785fa8.05675056.5f48f8215276c2.83332452.png" alt="" width="200" class="header-logo-right">
            </div>
          </div>
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_dropdown" id="id_231">
        ...
        <div id="cid_231" class="form-input" data-layout="half">
          <select class="form-dropdown" id="input_231" name="q231_sex" style="width:310px" data-component="dropdown" aria-labelledby="label_231">
            ...
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              ...
              <span class="form-address-line form-address-state-line jsTest-address-lineField ">
                <span class="form-sub-label-container" style="vertical-align:top">
                  ...
                  <label class="form-sub-label" for="input_4_state" id="sublabel_4_state" style="min-height:13px" aria-hidden="false"> Country </label>
                </span>
              </span>
            </div>
      ...
      <li class="form-line" data-type="control_dropdown" id="id_232">
        <label class="form-label form-label-left" id="label_232" for="input_232"> Maladies Chroniques: </label>
      ...
      <li class="form-line" data-type="control_textbox" id="id_119">
        <label class="form-label form-label-left" id="label_119" for="input_119"> antécédents: </label>
      ...
      <li class="form-line" data-type="control_textbox" id="id_118">
        <label class="form-label form-label-left" id="label_118" for="input_118"> Allergie: </label>
      ...
      <li class="form-line" data-type="control_textarea" id="id_22" style="z-index: 0;">
        <label class="form-label form-label-left" id="label_22" for="input_22">  commentaires: </label>
      ...
      <div class="form-description" style="display: none;"><div class="form-description-arrow"></div><div class="form-description-arrow-small"></div><div class="form-description-content">Please list all medications (DRUG NAME, DOSE, FREQUENCY, ROUTE) that you are currently prescribed, if more than one, separate them with a comma.</div></div></li>
